      ...
      <div className="w-full max-w-md z-10 space-y-6">
        ...
        <div className="bg-white rounded-3xl border border-slate-200/90 shadow-xl shadow-slate-200/60 overflow-hidden">
          ...
          <div className="bg-slate-900 p-6 text-center text-white relative">
            <div className="inline-flex items-center justify-center space-x-1.5 px-3 py-1 bg-cyan-500/10 border border-cyan-400/30 rounded-full text-cyan-300 text-[10px] font-extrabold uppercase mb-3">
            ...
            <div className="mt-3 inline-flex items-center space-x-1.5 px-3 py-1.5 bg-blue-600/30 border border-blue-400/40 rounded-full text-cyan-200 text-xs font-extrabold shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4 bg-white">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  required
                  placeholder="e.g. 9841234567 or user@gmail.com"
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600 focus:bg-white focus:ring-2 focus:ring-blue-600/20 transition-all"
              ...
              {form.password && (
                <div className="mt-2 space-y-1">
                  ...
                  <p className="text-[10px] font-bold text-slate-500 flex items-center justify-between">
                    ...
                    <span className="text-slate-700 font-extrabold">{strength.label}</span>
                  </p>
                </div>
              )}
            </div>
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">
                Invitation Code <span className="text-slate-400 font-normal lowercase">(Optional)</span>
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm font-bold text-slate-900 placeholder-slate-400 uppercase focus:outline-none focus:border-blue-600 focus:bg-white focus:ring-2 focus:ring-blue-600/20 transition-all"
            ...
            <div className="pt-4 border-t border-slate-100 text-center">
              <p className="text-xs text-slate-600 font-medium">
                ...
                <Link href="/login" className="font-extrabold text-blue-600 hover:text-blue-700 underline underline-offset-4">
                  Sign In Here
                </Link>
              </p>
            </div>
...
export default function RegisterPage() {
  return (
    <Suspense fallback={<div className="p-8 text-center text-xs text-slate-500">Loading registration terminal...</div>}>
      <RegisterForm />
    </Suspense>
  );
}
